...
input:
 set val(db_name), file(germlineFile) from g_2_germlineFastaFile_g_89

output:
 file ndm_file  into g_89_outputFileTxt0_g0_9
...
input:
 ...
 file auxiliary_data from g_88_outputFileTxt0_g0_9
 file custom_internal_data from g_89_outputFileTxt0_g0_9
...
output:
 ...
 set val("${call}_personal_reference"), file("${call}_personal_reference.fasta") optional true  into g_75_germlineFastaFile11
